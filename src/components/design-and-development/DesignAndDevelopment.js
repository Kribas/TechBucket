...
import './DesignAndDevelopment.css'
import WhatWeDoItem from '../what-we-do/WhatWeDoItem'
import Testimonials from '../testimonials/Testimonials'
import Footer from '../footer/Footer'

export default function DesignAndDevelopment({title}) {
  return (
    <div className='design-and-development'>
        ...
        <div className='container'>
          ...
          <div className="design-and-development__title">
          <h3>{title}</h3>
        </div>

        <div className="design-and-development__desc">
          <p>
        ...
        <div className="row">
          <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6">
            <Link className="text-decoration-none" to="/designanddevelopmentconsulting">
              <WhatWeDoItem
          ...
          <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6">
            <Link to="/designanddevelopmentservices" className="text-decoration-none">
              <WhatWeDoItem
          ...
          <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6">
            <Link to='/ourprojects' className="text-decoration-none">
              <WhatWeDoItem
